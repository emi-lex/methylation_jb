...
def preprocess_data(file_name: str, save: bool=True):
    """
    @param file_name: where is the initial data (including path and extension)
    @param save: whether to save the result
    @return: preprocessed file with data
    """
...
def preprocess_map_file(map_name: str, save: bool=True):
    """
    @param map_name: where is the initial file with mapping (including path and extension)
    @param save: whether to save the result
    @return: preprocessed file with mappping
    """
...
def preprocess_horvath_file(horvath_name: str, save=True):
    """
    @param horvath_name: where is the initial file with the horvath model information (including path and extension)
    @param save: whether to save the result
    @return: preprocessed file with horvath information
    """
...
def preprocess_all(file_name: str, map_name: str, horvath_name: str):
    """
    @param file_name: where is the initial data (including path and extension)
    @param map_name: where is the initial file with mapping (including path and extension)
    @param horvath_name: where is the initial file with the horvath model information (including path and extension)
...
def get_chromosome_coords(chromosomes_arr):
    """
    @param chromosome_arr: array with chromosomes of the cytosines
    @return: dictionary from chromosome to the coordinates of its position in the chromosome_arr
    """
    i = 0
